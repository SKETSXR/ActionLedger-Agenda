...
from src.schema.input_schema import (
    ...
    QuestionGuidelinesSchema,
    SkillTreeSchema,
)
from src.schema.output_schema import (
    AnnotatedSkillTreeSummarySchema,
    CandidateProjectSummarySchema,
    CollectiveInterviewTopicSchema,
    DiscussionSummaryPerTopicSchema,
    DomainsToAssessListSchema,
    FocusAreaSchema,
    GeneratedSummarySchema,
    JobRequirementsSummarySchema,
    NodeSchema,
    NodesSchema,
    ProjectReasoningSummarySchema,
    TopicSchema,
...
def candidate():
    return CandidateProfileSchema(
        ...
        experience=[
            ExperienceSchema(id="E1", company="Acme", title="SWE", description="APIs")
        ],
    )
...
def qg():
    return QuestionGuidelinesCompleteSchema(
        question_guidelines=[
            QuestionGuidelinesSchema(
                question_type_name="Direct", question_guidelines="Be concise"
            ),
            QuestionGuidelinesSchema(
                question_type_name="Deep Dive", question_guidelines="Probe tradeoffs"
            ),
        ]
    )
...
def summary(skill_tree_3level, jd):
    return GeneratedSummarySchema(
        ...
        domains_assess_D=DomainsToAssessListSchema(
            domains=[
                DomainsToAssessListSchema.Domain(
            ...
            TopicSchema(
                ...
                focus_area=[
                    FocusAreaSchema(
                        ...
                        guideline="indexing choices",
                    ),
                    FocusAreaSchema(
                        skill="Node.js (advanced services, concurrency, resilience)",
                        guideline="concurrency/resilience",
                    ),
                ],
            ...
            TopicSchema(
                ...
                focus_area=[
                    FocusAreaSchema(
                        ...
                        guideline="versioning, rate limiting",
                    ),
                    FocusAreaSchema(
            ...
            TopicWithNodesSchema(
                ...
                nodes=[
                    NodeSchema(
                        ...
                        next_node=2,
                        context="ctx",
                        skills=["Postgres: indexing, query tuning, partitioning"],
                    ),
                    NodeSchema(
                        id=2,
                        ...
                        next_node=3,
                        context="ctx",
                        skills=["Node.js (advanced services, concurrency, resilience)"],
            ...
            TopicWithNodesSchema(
                ...
                nodes=[
                    NodeSchema(
                        ...
                        next_node=2,
                        context="ctx",
                        skills=["GraphQL & REST (scaling & governance)"],
                    ),
                    NodeSchema(
                        id=2,
                        question_type="Deep Dive",
                        ...
                        next_node=None,
                        context="ctx",
                        skills=["System design (throughput, latency, fault tolerance)"],
                        total_question_threshold=2,
                    ),
                ],
            ),
