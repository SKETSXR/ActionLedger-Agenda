...
- Each topic should be one of the following types <try to cover all of these types if possible>:
   - Project-related discussion  <This topic should mention the given project's actual name as mentioned and not keys like P1, P2, P5 etc. Also here, for this type of topic a relevant project is to be selected which has most number of skills written with a priority as must in the annotated skill tree>
