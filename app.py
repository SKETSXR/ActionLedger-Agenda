...
if __name__ == "__main__":
    ...
    JD_ID = int(os.environ.get("JD_ID", 5))
    CV_ID = int(os.environ.get("CV_ID", 5))
    ST_ID = int(os.environ.get("ST_ID", 5))
    ...
    output_txt_path = Path(os.environ.get("OUTPUT_TXT_PATH", r"testing\op241.txt"))
